...
modified: 2026-01-30T17:09:20+00:00
viewCount: 1
...
[[DevOps]] lead for a new internal branch within the company, creating the implementation process and then managing and supporting the development of a wide range of internal tracking tools for an Automotive project's lifecycle.
...
The role dropped me fully into a [[DevOps]] role, where I created the development process and set up the [[Azure DevOps]] system we used for all of the tools. I became [[DevOps]] lead, managing sprints whilst simultaneously supporting development of the tools and setting up the [[GPMO Documentation Site]].

We ultimately developed a fully synced system of tools that helped the company track and progress their project quotation and reporting process, bringing together the various regions of the company into a centrally aligned system.

>[!top] [Back to top](#Table%20of%20Contents)

## Key Achievement

The development and implementation of several [[Microsoft]] based tools that were used internally across the globe for managing projects and reporting finances to a single operations team, saving days of collation work for each region.
