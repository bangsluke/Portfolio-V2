...
longDescription: "This site provided the stag attendees with the full itinerary of the stag, with timings and <span class=\"theme-link\">Google Maps</span> links to each activity, designed for late attendees (or drunk attendees) to re-locate the group.<br>This site was a copy and rebrand from the <a href=\"/projects/js-stag-website\" class=\"theme-link\">JS Stag Website</a> I had previously built."
