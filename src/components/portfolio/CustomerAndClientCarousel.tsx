...
export default function ClientAndCustomerCarousel({
  ...
  useEffect(() => {
    try {
      ...
      console.log(
        'CustomerCarousel.tsx - Companies array length:',
      ...
      console.log(
        'CustomerCarousel.tsx - Number of carousel items:',
        items.length
      );
      ...
      console.error(
        'CustomerCarousel.tsx - Error parsing companies data:',
        error
      );
      console.error(
        'CustomerCarousel.tsx - Error details:',
