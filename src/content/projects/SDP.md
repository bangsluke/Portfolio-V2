...
Scalable web-based timing platform for automotive project management, used across multiple customers. Reduced programme planning time from months to days using [[Neo4j]] graph technology.
