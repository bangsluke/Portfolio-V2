...
modified: 2026-03-18T10:34:56+00:00
viewCount: 3
...
Acted as the product translation layer on [[SDP]] - a web platform used across multiple customers to develop scalable automotive program timing plans. Gathered requirements from domain experts, defined data structures across [[SQL]] and [[Neo4j]] databases, and bridged the gap between operational needs and engineering execution across a 3-year delivery. Built a custom Excel interface to allow non-technical users to input and manage structured graph data.
...
Responsibilities also include supporting decisions on the architecture of the tool, shaping the [[UI]]/[[UX]] and hiring and managing the offshore developers to ensure smooth delivery. I helped architect the database structure, storing our data in an [[SQL]] database managed by me and then populating a [[Neo4j]] graph for running the algorithms through.
