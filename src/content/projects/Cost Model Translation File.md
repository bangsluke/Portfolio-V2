...
The automation file to convert the [Cost Model](Cost Model) into the data format required for the [Financial Tracker|Finance Tracker](Financial Tracker|Finance Tracker).
