...
version: 1
portfolioOrder: 3
shortDescription: "A landing page for showcasing a new Automotive Consultancy branch of <p class=\"mint-link\">RLE</p>, known as <p class=\"mint-link\">RLE</p>, known as <p class=\"mint-link\">Centre of Excellence</p> ready for prospective clients to view and see the services we provide."
...
A landing page for showcasing a new Automotive Consultancy branch of <p class="mint-link">RLE</p>, known as <p class="mint-link">RLE</p>, known as <p class="mint-link">Centre of Excellence</p> ready for prospective clients to view and see the services we provide.
...
- Hosting: <p class="mint-link">GitLab</p> (see [Repositories](#repositories)), <p class="mint-link">Netlify</p>
- Security: n/a
