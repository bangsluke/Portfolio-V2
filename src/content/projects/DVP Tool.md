...
version: 1
portfolioOrder: 2
shortDescription: "Full-stack <span class=\"theme-link\">MVP</span> validating a multiple-objective optimisation approach to <span class=\"theme-link\">DVP</span> planning for automotive projects. Reduced planning time by more than 80% and secured stakeholder funding for further development."
...
Full-stack [[MVP]] validating a multiple-objective optimisation approach to [[DVP]] planning for automotive projects. Reduced planning time by more than 80% and secured stakeholder funding for further development.
